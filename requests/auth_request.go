...
func ValidateUpdateInfoRequest(c *fiber.Ctx) error {
	...
	if err := validateRequest(c, &req, errorMessages, "/auth/profile/update-info"); err != nil {
		return err
	}

	c.Locals("updateInfoRequest", req)
	return c.Next()
}
